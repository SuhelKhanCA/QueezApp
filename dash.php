...
<body  style="background:#eee;">
<div style="height:130px; border-bottom-style:inset;
  border-bottom-color:black;
  border-bottom-width: 25px;">
<div class="row">
<div class="col-lg-10">
<span
          style="font-family:'Merriweather, serif !important;';font-size:50px;color:#000000;margin:40% 50% 10% 52%;">QUIZEEZ</span>
...
if (!(isset($_SESSION['username']))  || ($_SESSION['key']) != '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
    ...
    include_once 'dbConnection.php';
    echo '<span class="pull-right top title1" ><span style="color:black"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <span class="log log1" style="color:black">' . $name . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:black"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}
?>
