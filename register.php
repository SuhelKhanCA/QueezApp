...
?>
  ...
  <style>
    .bg1{background:url("image//art.jpg");min-height:855px;background-repeat: repeat-x;background-color: #d2d2d2;-webkit-background-size:cover;-moz-background-size:cover;-o-background-size:cover;background-size:cover;}
  </style>
</head>

<body>
  <div style="height:200px; border-bottom-style:inset;
  ...
  border-bottom-width: 70px;">
    <div style="padding-top:17px;">
      <div class="col-lg-10">
        ...
        <span
          style="font-family:'Merriweather, serif !important;';font-size:50px;color:#000000;margin:20% 50% 10% 52%;">QUIZEEZ</span>
        <span style="font-family:'Alegreya SC',serif;color:#000000;font-size:2.5rem;margin-left:650px">A Computer quest
          for programmers</span>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content title1">
            <div class="modal-header">
              ...
              <h4 class="modal-title title1"><span style="color:darkblue;font-size:12px;font-weight: bold">Login to your
                  Account</span></h4>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <select id="gender" name="gender" placeholder="Select your gender" class="form-control input-md">
                  <option value="" <?php if (!isset($_GET['gender'])) echo "selected" ; ?>>Select Gender</option>
                  <option value="M" <?php if (isset($_GET['gender'])) { if ($_GET['gender']=="M" ) echo "selected" ; }
                    ?>>Male</option>
                  <option value="F" <?php if (isset($_GET['gender'])) { if ($_GET['gender']=="F" ) echo "selected" ; }
                    ?>>Female</option>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-12">
                <select id="branch" name="branch" placeholder="Select your branch" class="form-control input-md">
                  <option value="" <?php if (!isset($_GET['branch'])) echo "selected" ; ?>>Select Branch</option>
                  <option value="CSE" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="CSE" ) echo "selected" ;
                    } ?>>Computer Science and Engineering</option>
                  <option value="ECE" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="ECE" ) echo "selected" ;
                    } ?>>Electronics and Communication Engineering</option>
                  <option value="EEE" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="EEE" ) echo "selected" ;
                    } ?>>Electrical and Electronics Engineering</option>
                  <option value="IT" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="IT" ) echo "selected" ; }
                    ?>>Information Technology</option>
                  <option value="CHEM" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="CHEM" ) echo "selected"
                    ; } ?>>Chemical Engineering</option>
                  <option value="CIVIL" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="CIVIL" )
                    echo "selected" ; } ?>>Civil Engineering</option>
                  <option value="MECH" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="MECH" ) echo "selected"
                    ; } ?>>Mechanical Engineering</option>
                  <option value="BIOTECH" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="BIOTECH" )
                    echo "selected" ; } ?>>Biotechnology</option>
                  <option value="IMSC" <?php if (isset($_GET['branch'])) { if ($_GET['branch']=="IMSC" ) echo "selected"
...
?>">
  ...
  <div class="row footer">
    ...
    <div class="col-md-2 box">
      <a href="feedback.php" style="color:lightyellow;text-align:right;" onmouseover="this.style('color:yellow')"
        target="new">Feedback</a>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><span style="color:darkblue;font-size:12px;font-weight: bold">Login to Server</span>
            </h4>
          </div>
          <div class="modal-body title1">
            <div class="row">
              ...
              <div class="col-md-6">
                <form role="form" method="post" action="admin.php?q=register.php">
                  <div class="form-group">
